...
import { setSettings,getSettings } from "../services/weather.service";
            ...
            <AnimatePresence>
                {
                    isOpen === true && (
                        ...
                        >
                            ...
                            <button onClick={saveSettings} id="save" className="rounded-lg bg-blue-400 w-full h-12 hover:bg-blue-500 transition-all">Save settings</button>
